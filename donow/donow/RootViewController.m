...
- (void)viewDidLoad
{
    ...
    DataViewController *startingViewController2 = [self.modelController viewControllerAtIndex:1 storyboard:storyboard];
    
    NSArray *viewControllers = @[startingViewController, startingViewController2];
